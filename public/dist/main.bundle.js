...
module.exports = "<div class=\"container\">\n    <div class=\"input-group\">\n        <span class=\"input-group-addon\" id=\"basic-addon1\">Search</span>\n        <input type=\"text\" class=\"form-control\" placeholder=\"Buscar por nombre\" aria-describedby=\"basic-addon1\">\n    </div>\n    <br>\n    <div class=\"table table-responsive\">\n        <table class=\"table table-bordered table-hover\">\n            <thead>\n                <tr>\n                    <th class=\"th text-center\">Id</th>\n                    <th class=\"th text-center\">Nombre</th>\n                    <th class=\"th text-center\">Telefono</th>\n                    <th class=\"th text-center\">Whatsapp</th>\n                    <th class=\"th text-center\">Correo</th>\n                    <th class=\"th text-center\">RFC</th>\n                    <th class=\"th text-center\">CURP</th>\n                </tr>\n            </thead>\n            <tbody>\n                <tr *ngFor=\"let customer of customers\">\n                    <td class=\"text-center\">{{customer.id}}</td>\n                    <td class=\"text-center\">{{customer.name}}</td>\n                    <td class=\"text-center\">{{customer.phone}}</td>\n                    <td class=\"text-center\">{{customer.whatsapp}}</td>\n                    <td class=\"text-center\">{{customer.email}}</td>\n                    <td class=\"text-center\">{{customer.rfc}}</td>\n                    <td class=\"text-center\">{{customer.curp}}</td>\n                </tr>\n            </tbody>\n        </table>\n    </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(_search) {
        var _this = this;
        this._search = _search;
        this.term$ = new __WEBPACK_IMPORTED_MODULE_2_rxjs_Subject__["a" /* Subject */]();
        this._search.search(this.term$).subscribe(function (result) { return _this.customers = result; });
        this.term$.next('new');
    }
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0__search_service__["a" /* SearchService */]])
    ], HomeComponent);
...
var SearchService = /** @class */ (function () {
    ...
    SearchService.prototype.rawsearch = function (term) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Headers */]({ 'Content-Type': 'application/json' });
        var search = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["e" /* URLSearchParams */]();
        search.set('srch', term);
        var obs = this._http.get('http://localhost/api/customersapi', { search: search })
